...
const CssMinify = () => {
	...
	return (
		<>
			<SEO
				title={'Online Free CSS Minifier Tools'}
				description={`Devtools.dev offers a free online CSS minifier tool that helps you reduce the size of your CSS files by removing unnecessary whitespace, comments, and other characters. Simply copy and paste your CSS code into the tool, click the "Minify CSS" button, and the tool will generate a minified version of your code that you can use on your website to improve page load times. This tool is completely free to use and doesn't require any installation or sign-up.`}
				keywords={
					'css minifier, css minifier online, css minifier tool, css minifier tools'
				}
				url={'https://www.devtoo1s.dev/minify-code/css-minify'}
			/>
			<div className="p-4 sm:ml-52 max-w-screen overflow-y-auto max-h-screen">
				<div className="my-20  max-w-screen-lg">
					<h3 className="mb-4 p-2 rounded text-lg sm:text-2xl text-yellow-500 w-full bg-[#1a1c2e]">
						CSS Minifier
					</h3>
					<div>
						<Editor
