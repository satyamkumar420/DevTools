...
const GradientBox = ({ colors, angle, onClick }) => {
  ...
  return (
    <div
      className="w-full sm:w-48 h-48 cursor-pointer rounded-lg shadow-lg mb-4 p-2 flex justify-center text-center items-center"
      style={style}
      onClick={onClick}
    >
      {style.background}
          ...
          <div className="mt-10">
            <div className="border-l-4 border-l-purple-500 p-2 text-sm sm:text-lg bg-[#1a1c2e]">
              <p className="text-blue-300">
                As a student or professional developer, it can be challenging to
                find the perfect color scheme for your project. That's why this
                tool is here to help! With just one click, it generates a
                variety of random gradient colors for you to choose from, making
                your work easier and more efficient. Plus, it even copies the
                colors for you. We hope this tool can be a valuable resource for
