...
const GradientColor = () => {
  ...
  const handleCopy = () => {
    ...
    toast("Gradient Copied!", { style: toastStyleSuccess });
  };
      ...
      <div className="p-4 sm:ml-52 max-w-screen overflow-y-auto max-h-screen">
        <div className="my-20 max-w-screen-lg">
          ...
          <div className="bg-[#1a1c2e] p-4 my-3 rounded-md">
            <p className="sm:text-xl text-lg bg-[#2c2f4b] p-2 rounded-md my-2  font-medium text-center sm:text-left text-gray-100">
              Choose Direction
            </p>
            ...
            <p className="text-lg sm:text-xl bg-[#2c2f4b] p-2 rounded-md my-2  font-medium text-center sm:text-left text-gray-100">
              Pick the Colors
            </p>
              ...
              {[
                ...
                <div className="text-center " key={index}>
                  ...
                  <input
                    ...
                    className="w-52 h-20 rounded-md"
                  />
                </div>
              ))}
            </div>
