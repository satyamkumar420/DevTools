...
const TextConverter = () => {
	...
	return (
		<>
			<SEO
				title={'Online Free Text Converter Tools'}
				description={
					'Online free text converter tools are web-based applications that allow users to transform text in various ways without the need for manual editing. These tools often include features such as converting text to uppercase or lowercase, changing text to snake_case or camelCase, and performing other text formatting tasks. They are useful for quickly modifying the appearance or structure of text for different purposes, such as coding conventions or stylistic preferences.'
				}
				keywords={
					'text converter, text converter online, text converter tools, text converter tools online, lowercase, uppercase, snake_case, camelCase, convert to alternate case, convert to alternate case online, convert to alternate case tools, convert to alternate case tools online'
				}
				url={'https://www.devtoo1s.dev/text/text-converter'}
			/>
