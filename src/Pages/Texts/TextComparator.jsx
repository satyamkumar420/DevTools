...
const TextComparator = () => {
	...
	return (
		<>
			<SEO
				title={'Online Free Text Comparator Tools'}
				description={
					'Online free text comparator tools analyze two or more text documents, highlighting the similarities and differences between them. They often provide features such as difference highlighting, side-by-side views, and detailed reports to assist users in comparing and understanding changes in the content.'
				}
				keywords={
					'text comparator, text comparator online, free text comparator, word comparator, word comparator online, paragraph comparator, paragraph comparator online'
				}
				url={'https://www.devtoo1s.dev/texts/text-comparator'}
			/>
