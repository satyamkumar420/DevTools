          ...
          <div className="mt-10">
            <div className="text-left border-l-4 border-l-purple-500 p-2 text-sm sm:text-lg bg-[#1a1c2e]">
              <p className="text-blue-300">
                ...
                daunting task, but we&apos;re here to help make it easier for
                you. Our free online tool is designed to simplify text
                formatting, so you can focus on what&apos;s important. We would
                be delighted to assist you in converting your text to HTML
                effortlessly.
              </p>
            </div>
          </div>
